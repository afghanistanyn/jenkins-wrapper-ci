...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		//set api auth for custom role

		// 必选接口
		// /user/changePassword,POST,
		// /user/getUserInfo,GET,
		// /user/setSelfInfo,PUT,
		// /user/getUserList,POST
		// /user/setUserAuthority,POST,
		// /user/setUserInfo,PUT,
		// /jwt/jsonInBlacklist,POST,
		// /menu/getMenu,POST,



		{Ptype: "p", V0: "888", V1: "/project/findProject", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/project/getProjectList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/project/createProject", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/project/deleteProject", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/project/setProjectMembers", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/app/createApp", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/app/deleteApp", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/app/getAppList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/app/findApp", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/app/updateApp", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/build/approveBuild", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/build/buildInfo", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/build/createBuild", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/build/deleteBuild", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/build/findBuild", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/build/getBuildList", V2: "GET"},


		{Ptype: "p", V0: "999", V1: "/user/changePassword", V2: "GET"},
		...
		{Ptype: "p", V0: "999", V1: "/project/findProject", V2: "GET"},
		{Ptype: "p", V0: "999", V1: "/project/getProjectList", V2: "GET"},
		{Ptype: "p", V0: "999", V1: "/project/createProject", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/project/deleteProject", V2: "DELETE"},
		{Ptype: "p", V0: "999", V1: "/project/setProjectMembers", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/app/createApp", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/app/deleteApp", V2: "DELETE"},
		{Ptype: "p", V0: "999", V1: "/app/getAppList", V2: "GET"},
		{Ptype: "p", V0: "999", V1: "/app/findApp", V2: "GET"},
		{Ptype: "p", V0: "999", V1: "/app/updateApp", V2: "PUT"},
		{Ptype: "p", V0: "999", V1: "/build/approveBuild", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/build/buildInfo", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/build/createBuild", V2: "POST"},
		{Ptype: "p", V0: "999", V1: "/build/deleteBuild", V2: "DELETE"},
		{Ptype: "p", V0: "999", V1: "/build/findBuild", V2: "GET"},
		{Ptype: "p", V0: "999", V1: "/build/getBuildList", V2: "GET"},

		{Ptype: "p", V0: "1000", V1: "/user/changePassword", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/user/getUserInfo", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/user/setSelfInfo", V2: "PUT"},
		{Ptype: "p", V0: "1000", V1: "/user/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/user/setUserInfo", V2: "PUT"},
		{Ptype: "p", V0: "1000", V1: "/jwt/jsonInBlacklist", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/menu/getMenu", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/user/getUserList", V2: "POST"},
		//
		{Ptype: "p", V0: "1000", V1: "/project/findProject", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/project/getProjectList", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/project/setProjectMembers", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/app/createApp", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/app/deleteApp", V2: "DELETE"},
		{Ptype: "p", V0: "1000", V1: "/app/getAppList", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/app/findApp", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/app/updateApp", V2: "PUT"},
		{Ptype: "p", V0: "1000", V1: "/build/approveBuild", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/build/createBuild", V2: "POST"},
		{Ptype: "p", V0: "1000", V1: "/build/deleteBuild", V2: "DELETE"},
		{Ptype: "p", V0: "1000", V1: "/build/findBuild", V2: "GET"},
		{Ptype: "p", V0: "1000", V1: "/build/getBuildList", V2: "GET"},
...
func (i *initCasbin) DataInserted(ctx context.Context) bool {
	...
	if errors.Is(db.Where(adapter.CasbinRule{Ptype: "p", V0: "1000", V1: "/user/getUserInfo", V2: "GET"}).
